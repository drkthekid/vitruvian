...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope z-400 ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden' : 'w-full h-full'}`}>
      <div
        className={
        ...
        <header
          ...
          <a href="/">
            <div
              ...
              aria-label="Logo">
              <img
                src={logoUrl || (mounted && resolvedTheme === 'dark' ? '/logo/padrao-dark.png' : '/logo/padrao-light.png')}
                alt="Logo"
                className="size-25 block w-auto object-contain"
                draggable={false}
              />
            </div>
          </a>
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#e9e9ef] font-xl leading-none overflow-visible pointer-events-auto"
            ...
            <span
              ...
              <span
                ref={plusHRef}
                className="sm-icon-line absolute left-1/2 top-1/2 w-full h-[2px] bg-current rounded-xs -translate-x-1/2 -translate-y-1/2 will-change-transform" />
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-[2px] bg-current rounded-xs -translate-x-1/2 -translate-y-1/2 will-change-transform" />
            </span>
          </button>
        </header>
